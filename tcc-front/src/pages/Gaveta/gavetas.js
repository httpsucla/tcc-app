...
import Box2 from './components/Box/BoxGaveta';
            ...
            <View style={styles.container}>
                ...
                <View style={styles.flex}>
                    <View style={styles.gaveta}>
                        ...
                        <Box2 gaveta = {gavetas[0]} navigation = {this.props.navigation} db = {this.db} meds = {medicamentos} />
                    </View>
                    <View style={styles.gaveta}>
                        <Text style={styles.title}>Gaveta 2</Text>
                        <Box2 gaveta = {gavetas[1]} navigation = {this.props.navigation} db = {this.db} meds = {medicamentos}/>
                    </View>
                </View>
                <View style={styles.flex}>
                    <View style={styles.gaveta}>
                        <Text style={styles.title}>Gaveta 3</Text>
                        <Box2 gaveta = {gavetas[2]} navigation = {this.props.navigation} db = {this.db} meds = {medicamentos}/>
                    </View>
                    <View style={styles.gaveta}>
                        <Text style={styles.title}>Gaveta 4</Text>
                        <Box2 gaveta = {gavetas[3]} navigation = {this.props.navigation} db = {this.db} meds = {medicamentos}/>
                    </View>
                </View>
            </View>            
        )
